...
public class Cmp3400{
	 ...
	 * @throws Exception
	 */
	public Object[] getReqList(String UserId,String FindCd,String FindWord,String StDate,String EdDate,String ccbYn,String PrjNo,String PrjName,String Ilsu,String baseCd) throws SQLException, Exception {
		...
		try {
			...
			strQuery.append("       to_date(to_char(sysdate,'yyyymmdd'),'yyyymmdd') - to_date(to_char(a.cr_acptdate,'yyyymmdd'),'yyyymmdd') dayTerm, \n");
			...
			strQuery.append("       e.cm_deptname,f.cm_username,h.cd_dirpath,                               \n");
			strQuery.append("       j.cr_docfile,b.cr_ccbyn                                                 \n");
			strQuery.append("  from cmr0030 j,cmd0305 h,cmm0040 f,cmm0100 e,cmd0300 c,                      \n");
			strQuery.append("       cmr1100 b,cmr1000 a                                                     \n");
			strQuery.append(" where a.cr_qrycd in ('31','32') and a.cr_status not in ('0','3')              \n");
			...
			strQuery.append("   and j.cr_status = '5'                                                       \n");
			...
			if (Ilsu != null && Ilsu != "") {
				pstmt.setInt(++parmCnt, Integer.parseInt(Ilsu));
			}
			...
			while (rs.next()){
				...
				rst.put("dayTerm",Integer.toString(rs.getInt("dayTerm")));
				rsval.add(rst);
				rst = null;
			...
			ecamsLogger.error("## Cmp3400.getReqList() SQLException START ##");
			ecamsLogger.error("## Error DESC : ", sqlexception);
			ecamsLogger.error("## Cmp3400.getReqList() SQLException END ##");
			throw sqlexception;
		} catch (Exception exception) {
			exception.printStackTrace();
			ecamsLogger.error("## Cmp3400.getReqList() Exception START ##");
			ecamsLogger.error("## Error DESC : ", exception);
			ecamsLogger.error("## Cmp3400.getReqList() Exception END ##");
			throw exception;
		}finally{
			...
			if (conn != null){
				try{
					...
					ecamsLogger.error("## Cmp3400.getReqList() connection release exception ##");
					ex3.printStackTrace();
				}
			}
		}
	}//end of getReqList() method statement
}//end of Cmp3400 class statement
