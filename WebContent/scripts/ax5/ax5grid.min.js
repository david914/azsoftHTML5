...
(function() {
    ...
    var repaint = function repaint(_reset) {
        ...
        var repaintBody = function repaintBody(_elTargetKey, _colGroup, _bodyRow, _groupRow, _list, _scrollConfig) {
            ...
            if(temp1 > _list.length){	// 그리드 다 채워주는내용 수정
            	var azaz; 
            	var zpzpzpzp;
            	for(azaz = _list.length, zpzpzpzp = temp1 ; azaz <= zpzpzpzp ; azaz++){
            		SS.push('<tr class="tr-' + azaz % 4 + '" data-ax5grid-tr-data-index="'+ azaz +'" data-ax5grid-tr-data-o-index="' + azaz +'" data-ax5grid-selected="false" data-ax5grid-disable-selection="false">');
            		 for (tri = 0, trl = _colGroup.length; tri < trl; tri++) {
            			 SS.push('<td data-ax5grid-panel-name="body-scroll" data-ax5grid-column-row="0", data-ax5grid-column-col="'+trl+'" data-ax5grid-data-index="' + azaz + '" data-ax5grid-data-o-index="' + azaz + '" data-ax5grid-column-rowindex="0" data-ax5grid-column-attr="default" data-ax5grid-column-colindex="'+ tri +'" class="hasBorder isLastColumn " style="height: ' + cfg.body.columnHeight + 'px;min-height: 1px;">');
