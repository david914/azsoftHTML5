					...
					<div class="row">
						<div class="width-100 rowItem">
							...
							<div class="item">
								...
								<div id="reqDept" data-ax5select="reqDept" data-ax5select-config="{size:'sm',theme:'primary'}" class="block1 ml_80 dib">
							    </div>
							...
							<div class="item">
								...
								<div id="srStat" data-ax5select="srStat" data-ax5select-config="{size:'sm',theme:'primary'}" class="block1 ml_80 dib">
							    </div>
					...
					<div class="row">
						<div class="width-100 rowItem">
							...
							<div class="item">
								...
								<div id="reqDept" data-ax5select="devDept" data-ax5select-config="{size:'sm',theme:'primary'}" class="block1 ml_80 dib">
							    </div>
