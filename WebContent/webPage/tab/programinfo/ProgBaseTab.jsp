...
<div id="wrapper" style="height:100%">
	...
	<div class="margin-5-top">
        ...
        <div class="ml_80">
			<input id="txtStory" name="txtStory" type="text" class="width-100" style="width:calc(100% - 5px);">
		</div>
	</div>			
	<div class="margin-5-top por">
        <label id="lbDir" class="tit_80 poa">프로그램경로</label>
        <div class="ml_80" id="divDirTxt">
			<input id="txtDir" name="txtDir" type="text" class="width-100" style="width:calc(100% - 5px);">
		</div>
        <div class="ml_80" id="divDirCbo">
		    <div id="cboDir" data-ax5select="cboDir" data-ax5select-config="{size:'sm',theme:'primary'}" class="width-100 dib" style="width:calc(100% - 5px);"></div>
		</div>
					...
					<div class="l_wrap">
						<div>
			                ...
			                <div class="dib vat">
			                    ...
			                    <div class="ml_80">
									<label class="title_s" id="lbckin">체크인</label><input id="txtCkInEditor" name="txtCkInEditor" type="text" class="dib" style="width:calc(25% - 45px);">
									<label class="title_s" id="lbdev">개발</label><input id="txtDevEditor" name="txtDevEditor" type="text" class="dib" style="width:calc(25% - 45px);">
									<label class="title_s" id="lbtest">테스트</label><input id="txtTestEditor" name="txtTestEditor" type="text" class="dib" style="width:calc(25% - 45px);">
									<label class="title_s" id="lbreal">운영</label><input id="txtRealEditor" name="txtRealEditor" type="text" class="dib" style="width:calc(25% - 45px);">
								</div>
							</div>
						</div>						
						<div class="margin-5-top">
			                ...
			                <div class="dib vat">
			                    ...
			                    <div class="ml_80">
									<input id="txtCkInLastDt" name="txtCkInLastDt" type="text" class="dib" style="width:20%;">
									<input id="txtDevLastDt" name="txtDevLastDt" type="text" class="dib" style="width:20%;">
									<input id="txtTestLastDt" name="txtTestLastDt" type="text" class="dib" style="width:20%;">
									<input id="txtRealLastDt" name="txtRealLastDt" type="text" class="dib" style="width:20%;">
								</div>
							</div>
						</div>
					</div>
	...
	<div class="tar margin-10-top margin-10-right">
		<button id="btnDel" name="btnDel" onclick="btnDel_Click()" class="btn_basic">삭제</button>
		<button id="btnRegist" name="btnDiff" onclick="btnDiff_Click()" class="btn_basic">소스비교</button>
		<button id="btnView" name="btnView" onclick="btnView_Click()" class="btn_basic">소스보기</button>
		<button id="btnDiff" name="btnRegist" onclick="btnRegist_Click()" class="btn_basic">수정</button>
