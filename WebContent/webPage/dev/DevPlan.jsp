		...
		<div class="half_wrap margin-10-top">
			...
			<div class="half_wrap margin-10-top" style="height:50%"> <!--  tab_container -->
		       	...
		       	<div id="tabSRRegister" class="tab_content mask_wrap" style="width:100%">
		       		<iframe id="frmSRRegister" name="frmSRRegister" src='/webPage/srcommon/SRRegisterTab.jsp' width='100%' height='100%' frameborder="0"></iframe>
		       	</div>
		       	<!-- SR등록/접수  END -->
		       	
		       	<!-- 개발계획/실적등록 START -->
		       	<div id="tabDevPlan" class="tab_content" style="width:100%">
		       		<iframe id="frmDevPlan" name="frmDevPlan" src='/webPage/srcommon/DevPlanTab.jsp' width='100%' height='100%' frameborder="0"></iframe>
		       	</div>
		       	<!-- 개발계획/실적등록 END -->
		   	</div>
