...
<div class="contentFrame">
	...
	<div class="row half_wrap_cb">
		...
		<div class="r_wrap width-30">
			<div style="height: 45px; background: linear-gradient(to bottom, #f0f0f0, #fff, #f0f0f0)">
				<label class="md-font margin-20-left margin-10-top">파이차트</label>
			</div>
			<div class="panel-body text-center dib margin-20-left" id="pieDiv" style="width: 95%;">
		    	<div id="pieAppliKinds" tooltip="아." flow="down"></div>
		    </div>
		</div>
	</div> 
	<!-- <div class="row">
