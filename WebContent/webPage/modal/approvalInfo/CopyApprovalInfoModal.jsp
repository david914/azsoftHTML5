...
<div class="container-fluid pop_wrap">
	...
	<div class="row half_wrap_cb">
		...
		<div class="l_wrap width-30">
			<div class="margin-5-right">
		        ...
		        <div class="ml_80">
					<div id="cboFromSys" data-ax5select="cboFromSys" data-ax5select-config="{size:'sm',theme:'primary'}" class="width-100 dib">
				    </div>
				</div>
			</div>
	 	</div>
	...
	<div class="row">
	    ...
	    <div class="ml_80">
			<div id="cboToReqCd" data-ax5select="cboToReqCd" data-ax5select-config="{size:'sm',theme:'primary'}" class="width-20 dib">
			</div>
			<div class="vat dib">
