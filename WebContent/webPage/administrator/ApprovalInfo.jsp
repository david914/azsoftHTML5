    ...
    <div class="content">
		...
		<div class="az_search_wrap">
			<div class="az_in_wrap por">
				...
				<!--컨텐츠버튼 S-->
				<div class="tar">
					<button class="btn_basic_s margin-5-left" data-grid-control="excel-export" id="btnReq">등록</button>
					<button class="btn_basic_s margin-5-left" data-grid-control="excel-export" id="btnDel">폐기</button>
					<button class="btn_basic_s margin-5-left" data-grid-control="excel-export" id="btnQry">조회</button>
					<button class="btn_basic_s margin-5-left" data-grid-control="excel-export" id="btnAllQry">전체조회</button>
					<button class="btn_basic_s margin-5-left" data-grid-control="excel-export" id="btnCopy">결재정보복사</button>
					<button class="btn_basic_s margin-5-left" data-grid-control="excel-export" id="btnBlank">대결범위등록</button>
				</div>
				<!--컨텐츠버튼 E-->
			</div>
		</div>
	    ...
	    <div class="az_board_basic" style="height:50%">
	    	<div data-ax5grid="grdSign" data-ax5grid-config="{showLineNumber: true, lineNumberColumnWidth: 40}" style="height: 100%;"></div>
		</div>	
		<!-- 게시판 E -->
    </div>
</div>
