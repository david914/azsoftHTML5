...
<div class="content">    	
	...
	<div class="half_wrap">
		...
		<div class="r_wrap dib width-60 vat">
			...
			<div class="width-100 dib" style="height: 18%; border: 1px dotted gray;; background-color: white; overflow-y: auto;">
		...
		<div class="l_wrap dib width-38 vat">
			...
			<div class="width-83 dib" style="height: 11%; border: 1px dotted gray;; background-color: white; overflow-y: auto;">
