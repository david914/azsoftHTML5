				...
				<div class="row">
					...
					<!-- 업무 -->
	               	<div class="width-33 dib vat">
	                   	...
	                   	<div class="ml_80">
							<div id="cboJob" data-ax5select="cboJob" data-ax5select-config="{size:'sm',theme:'primary'}" style="width:90%;" class="width-80 dib"></div>
						</div>
					</div>
				    <!-- 프로그램종류 -->
					<div class="width-33 dib vat ml_7">
						...
						<div class="ml_80 width-80">
							<div id="cboJawon" data-ax5select="cboJawon" data-ax5select-config="{size:'sm',theme:'primary'}" style="width:100%;" class="width-90 dib"></div>
						</div>
					</div>
				</div>
	...
	<div class="az_search_wrap margin-5-top">
		<div class="row">
	        ...
	        <div class="width-33 dib vat" style="float:right">
	            <label class="tit_80 poa">업무</label>
	            <div class="ml_80">
					<div id="cboAftJob" data-ax5select="cboAftJob" data-ax5select-config="{size:'sm',theme:'primary'}" class="dib" style="width:100%"></div>
				</div>
			</div>
	        ...
	        <div class="width-33 dib vat">
	            ...
	            <div class="ml_80">
					<div id="cboAftJawon" data-ax5select="cboAftJawon" data-ax5select-config="{size:'sm',theme:'primary'}" class="width-80 dib"></div>
				</div>
			</div>
			...
			<div class="width-33 dib vat">
	            ...
	            <div class="ml_80">
					<div id="cboAftOwner" data-ax5select="cboAftOwner" data-ax5select-config="{size:'sm',theme:'primary'}" class="width-80 dib"></div>
				</div>
			</div>	
		</div>
		...
		<div class="row">
			<!-- 경로 -->
			<div class="width-48 dib vat" style="float:right">
	            <label class="tit_80 poa">경로</label>
	            <div class="ml_80">
					<div id="cboAftDir" data-ax5select="cboAftDir" data-ax5select-config="{size:'sm',theme:'primary'}" class="dib" style="width:100%"></div>
				</div>
			</div>
			
			<!-- SR-ID -->
	        <div class="width-48 dib vat">
	            <label class="tit_80 poa">SR-ID</label>
	            <div class="ml_80">
					<div id="cboAftSRID" data-ax5select="cboAftSRID" data-ax5select-config="{size:'sm',theme:'primary'}" class="width-80 dib"></div>
				</div>
				<!-- 수정 -->
