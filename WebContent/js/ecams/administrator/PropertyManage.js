...
function saveSvrProperties() {
	...
	data = {
		...
		dbuser 		: txtUser,
		dbpass 		: txtPass,
		requestType	: 'saveSvrProperties'
	}
	ajaxAsync('/webPage/administrator/PropertyManage', data, 'json',successSaveSvrProperties);
}
...
function saveProperties() {
	...
	data = {
		...
		requestType	: 'saveProperties'
	}
	ajaxAsync('/webPage/administrator/PropertyManage', data, 'json',successSaveProperties);
}
...
function getSvrProperties() {
	...
	ajaxAsync('/webPage/administrator/PropertyManage', data, 'json',successGetSvrProperties);
}
...
function getProperties() {
	...
	ajaxAsync('/webPage/administrator/PropertyManage', data, 'json',successGetProperties);
}
