...
function requestCheckIn() {
	...
	ajaxAsync('/webPage/administrator/BatchReg', data, 'json',successRelatUpdt);
}
...
function getModListExcel() {
	...
	var tmpData = {
		...
		dataObj		: dataObj,
		requestType	: 'getModListExcel'
	}
	ajaxAsync('/webPage/administrator/BatchReg', tmpData, 'json',successGetModListExcel);
}
...
function getSysInfoMap() {
	...
	data = {
		...
		SecuYn 		: 'Y',
		SelMsg 		: 'SEL',
		requestType	: 'getSysInfoMap'
	}
	ajaxAsync('/webPage/administrator/BatchReg', data, 'json',successGetSysInfoMap);
}
