...
function delEtcDir() {
	...
	ajaxAsync('/webPage/administrator/FileConfiguration', data, 'json',successDelEtcDir);
}
//예외디렉토리 삭제 완료
...
function setEtcDir() {
	...
	ajaxAsync('/webPage/administrator/FileConfiguration', data, 'json',successSetEtcDir);
}
// 예외디렉토리 등록 완료
...
function getEtcDir() {
	...
	ajaxAsync('/webPage/administrator/FileConfiguration', data, 'json',successGetEtcDir);
}
// 예외 디렉토리 리스트 가져오기 완료
...
function getSysDir() {
	...
	ajaxAsync('/webPage/administrator/FileConfiguration', data, 'json',successGetSysDir);
}
