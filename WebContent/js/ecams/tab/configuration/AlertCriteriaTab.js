...
function delNotiList() {
	...
	data = {
		UserId 		: '',
		delList 	: delList,
		requestType	: 'delNotiList'
	}
	ajaxAsync('/webPage/administrator/Configuration', data, 'json',successDelNotiList);
}
...
function insertNotiList() {
	...
	data = {
		...
		requestType	: 'insertNotiList'
	}
	ajaxAsync('/webPage/administrator/Configuration', data, 'json',successInsertNotiList);
}
...
function insertNotiInfo() {
	...
	data = {
		...
		requestType	: 'insertNotiInfo'
	}
	ajaxAsync('/webPage/administrator/Configuration', data, 'json',successInsertNotiInfo);
}
...
function getNotiInfo() {
	var data = new Object();
	data = {
		requestType	: 'getNotiInfo'
	}
	ajaxAsync('/webPage/administrator/Configuration', data, 'json',successGetNotiInfo);
}
...
function successGetNotiInfo(data) {
	...
	if(cboUserData[0].gbncd === 'SMS') {
		$('#txtSMSSend').val(cboUserData[0].smstelno);
...
function getNotiList() {
	var data = new Object();
	data = {
		requestType	: 'getNotiList'
	}
	ajaxAsync('/webPage/administrator/Configuration', data, 'json',successgetNotiList);
}
// 알림 정보 리스트 가져오기 완료
