...
$(document).ready(function() {
	...
	$('#cboCattype').bind('change', function() {
		...
		ajaxAsync('/webPage/administrator/Configuration', data, 'json',successGetSrCatType);
	});
...
function setSrCatType() {
	...
	ajaxAsync('/webPage/administrator/Configuration', data, 'json',successSetSrCatType);
}
