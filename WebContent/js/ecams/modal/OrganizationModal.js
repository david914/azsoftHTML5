...
function addMenu() {
	...
	confirmDialog.prompt({
        ...
        if(this.key === 'ok') {
        	...
        	ajaxAsync('/webPage/modal/TreeOrganization', data, 'json',successInsertNewDir);
        }
    });
}
...
function addSubMenu() {
	...
	confirmDialog.prompt({
        ...
        if(this.key === 'ok') {
        	...
        	ajaxAsync('/webPage/modal/TreeOrganization', data, 'json',successInsertNewSubDir);
        }
    });
}
...
function delMenu() {
	...
	confirmDialog.confirm({
		...
		if(this.key === 'ok') {
			...
			ajaxAsync('/webPage/modal/TreeOrganization', data, 'json',successCheckDelDir);
		} else {
			selectedNode 	= null;
			insertNode 		= null;
		}
...
function deleteDir() {
	...
	ajaxAsync('/webPage/modal/TreeOrganization', data, 'json', successDelDir);
}
...
function reMenu() {
	...
	confirmDialog.prompt({
        ...
        if(this.key === 'ok') {
        	...
        	ajaxAsync('/webPage/modal/TreeOrganization', data, 'json',successReNameDir);
        }
    });
}
// 트리 구분명 변경 완료
